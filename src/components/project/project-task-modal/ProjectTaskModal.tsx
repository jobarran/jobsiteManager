...
export const ProjectTaskModal = ({ projectId }: Props) => {
    ...
    const modalClasses = isTaskModalOpen
        ? 'fixed top-0 right-0 bottom-0 flex flex-col w-full lg:w-1/3 h-full transition-right-left duration-300 transform translate-x-0 bg-white z-30'
        : 'fixed top-0 left-full bottom-0 flex flex-col w-full lg:w-1/3 h-full transition-right-left duration-300 transform translate-x-full bg-white';
    ...
    return (
        <>
            ...
            >
                ...
                <div className="p-4 md:p-5 border-l dark:border-gray-600 h-screen">
